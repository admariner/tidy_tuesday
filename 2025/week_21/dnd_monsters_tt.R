...
(plot <- teeth_data %>% 
  ...
  theme_void() +
  theme(
    panel.background = element_rect(fill = "#0f0c0e", colour = "#0f0c0e"),
    strip.text = element_text(colour = "#EEEEEE", size = 130, lineheight = 0.3, margin = margin(10, 0, 10, 0)),
    strip.background = element_rect(fill = "#0f0c0e", colour = "#0f0c0e"),
    plot.background = element_rect(fill = "#0f0c0e", colour = "#0f0c0e"),
